        ...
        <div className="max-w-3xl mx-auto space-y-4 text-left">
          ...
          <div className="glow-card rounded-2xl bg-white/5 p-5 md:p-7">
            <article className="space-y-4 leading-8 tracking-wide text-[15px] md:text-base">
              <p>
                小朋友認識你是我一生的緣分 愛上小朋友更是我一生的幸福 我愛妳並不是為了摟摟抱抱 而是情不自禁的在乎你、關心你、惦記你、想懂你 這些不是因為我執著 而是因為你值得 我不管外界如何 那些都和我沒關係 在我眼裡小朋友才是最好嘟也是我最喜歡嘟 從認定妳ㄉ那天開始 我就準備要一直護著小朋友 不要質疑我對妳ㄉ愛 說愛妳就要一直愛下去 我愛妳 並將在每一個愛妳的日子里 用盡我所有的一切
              </p>
              <p>
